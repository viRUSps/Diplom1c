...
Процедура ВыполнитьЗаполнениеНаСервере()
	...
	Если Объект.Договор.Пустая() Тогда
        Сообщить("Сначала необходимо выбрать договор.");
        Возврат;
    КонецЕсли;
    ...
    Если Объект.Договор.ВидДоговора = Перечисления.ВидыДоговоровКонтрагентов.ВКМ_АбонентскоеОбслуживание Тогда
        ...
        Попытка
            ...
            Сообщить("Заполнение выполнено успешно.");
        Исключение
            Сообщить("Ошибка выполнения");
        КонецПопытки;
        
    Иначе
        Сообщить("Автозаполнение доступно только для договоров абонентского обслуживания.");
    КонецЕсли;
